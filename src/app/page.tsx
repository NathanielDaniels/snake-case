      ...
      <section>
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 x1:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto md:ml-10 text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t via-slate-50/50 from-slate-50 h-28" />
                <img className="w-full" src="/snake-1.png" alt="snake logo" />
              </div>
              ...
              <div className="space-y-2">
                <ul className="mt-8 mb-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
          ...
          <div className="col-span-full lg:col-span-1 w-full flex xl:justify-start justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit ">
